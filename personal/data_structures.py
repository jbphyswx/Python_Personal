...
""" f'{<name here>=}'.split('=')[0] returns variable name as a string, can't be made into fcn see https://stackoverflow.com/questions/18425225/getting-the-name-of-a-variable-as-a-string """
